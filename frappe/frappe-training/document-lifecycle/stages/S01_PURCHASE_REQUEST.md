...
`Is Submittable` сейчас выключен намеренно. Пока окончательное согласование не объявлено системным зафиксированным фактом, `docstatus` нам не нужен как механизм процесса.
...
## 6. Сохранить DocType и проверить source
