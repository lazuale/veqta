...
| [S08](S08_APP_STATE_DELIVERY.md) | разобрано, какое состояние принадлежит App, а какое Site |
| [S09](S09_CLEAN_INSTALL.md) | приложение проверено установкой на новый чистый Site |

После S09 получается небольшое, но полностью воспроизводимое приложение: модель и правила хранятся в `App`, а рабочие данные остаются на `Site`.
