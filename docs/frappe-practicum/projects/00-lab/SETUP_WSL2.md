...
Он не использует приложение, site, данные или Git-репозиторий VEQTA.
...
Для воспроизводимости P0 используем тот же проверенный стек, на котором фиксируется курс:
...
Этот стенд используется только для курса Frappe и никак не связан с VEQTA.