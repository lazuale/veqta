...
| Механизм | Впервые | Статус | Зачем |
|---|---:|---|---|
| DocType / DocField / Document / `name` | P0/P1 | Основное | в P0 увидеть metadata и запись; в P1 полноценно изучить модель |
| Standard DocType своего app | P0/P1 | Основное | в P0 создать пробный объект; в P1 строить предметную модель |
