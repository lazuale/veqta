...
Не сохраняй этот тестовый Document.
...
Создай новый Request ещё раз или обнови уже открытую новую форму.

Заполни только обязательный `Subject` и убедись, что отсутствие `Due Date` больше не блокирует Save.

Если создал проверочный Document, можешь оставить его со значениями:
...
Существующие Request Documents сохранены; новых может стать больше из-за эксперимента с Default.
