...
Статус: **принятый и завершённый маршрут CORE**.

CORE — фундаментальный практикум по архитектуре собственного Frappe App. Он не является полным каталогом архитектуры Framework; последующие контуры должны появляться отдельными практикумами из новых требований, а не продолжением нумерации ради покрытия функций.
