...
Таким образом, наличие Kanban, Gantt, уведомлений, входных каналов или повторяемости не является основанием добавлять собственные движки в Work Management.
